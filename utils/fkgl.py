...
if __name__ == "__main__":
    ...
    # with open('/home/yue/phd/scpn-master/script/best_outputs/WikiLarge/test/lower/SBMT-SARI.lower','r') as f:
    with open('/home/yue/phd/scpn-master/script/best_outputs/WikiLarge/test/Reference', 'r') as f:
        text = f.readlines()
